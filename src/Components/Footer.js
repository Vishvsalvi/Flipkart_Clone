...
const Footer = React.memo(() => {
  ...
  <aside className="hidden lg:relative lg:col-span-2 lg:block">
    <img
      alt="Art"
      src="https://images.unsplash.com/photo-1654573817889-296cad084c97?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8ZmxpcGthcnR8ZW58MHx8MHx8&auto=format&fit=crop&w=600&q=60"
  ...
  <div className="px-4 pt-16 pb-2 sm:px-6 lg:col-span-3 lg:px-8">
    <div className="grid grid-cols-2 gap-8 sm:grid-cols-2">
      <div>
        <div className="mt-16 flex gap-3">
          ...
          <a
            className="rounded-full border border-white/25 p-2 hover:opacity-75"
            href="https://github.com/Vishvsalvi"
            target="_blank"
            rel="noreferrer"
          >
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <nav className="mt-4 flex flex-col space-y-2 text-sm text-gray-300">
            ...
            <a className="hover:opacity-75" href="/"> Founder </a>
            <a className="hover:opacity-75" href="/"> Our Vision </a>
            <a className="hover:opacity-75" href="/"> Flipkart Stories </a>
          </nav>
        </div>
      </div>
    </div>
    ...
    <div className="mt-12 border-t border-gray-800 pt-12">
      ...
      >
        ...
        <p className="mt-4 sm:mt-0">&copy; 2022 Flipkart_clone</p>
      </div>

      <p className="mt-8 text-xs text-gray-500">
      Flipkart_clone is an Indian e-commerce company, headquartered in Mumbai, and incorporated in India as a private limited company, founded by Vishv Salvi with his superior React.js skills 
      </p>
    </div>
  </div>
</footer>
